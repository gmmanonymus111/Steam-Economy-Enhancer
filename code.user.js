// ==UserScript==
// @name        Steam Economy Enhancer w/ steamrep
// @namespace   https://github.com/Nuklon
// @author      Nuklon
// @license     MIT
// @version     6.0.1
// @description Enhances the Steam Inventory and Steam Market. Needs https://chrome.google.com/webstore/detail/disable-content-security/ieelmcmcagommplceebfedjlakkhpden to function properly!
...
(function ($, async) {
	...
	const PAGE_STEAMID = 4;
    const PAGE_STEAMPROFILE = 5;
    ...
    var currentPage = window.location.href.includes('.com/market')
        ...
        : (window.location.href.includes('.com/tradeoffer')
            ? PAGE_TRADEOFFER
            : PAGE_INVENTORY);
	var currentPage2 = window.location.href.includes('.com/id')
        ? PAGE_STEAMID
        : PAGE_STEAMPROFILE;
			
	var g_rgAppContextData;
	if (typeof g_rgAppContextData === 'undefined' || !g_rgAppContextData) {
	...
	if ((currentPage2 == PAGE_STEAMID) || (currentPage2 == PAGE_STEAMPROFILE)) {
			//console.log('adding steamrep...2');
			add_steamrep_api();
	}
	...
	function add_steamrep_api() {
		...
		if(!window.location.href.includes('games') && !window.location.href.includes('inventory') && !window.location.href.includes('screenshots') && !window.location.href.includes('videos') && !window.location.href.includes('workshopfiles') && !window.location.href.includes('recommended') && !window.location.href.includes('images')) {
